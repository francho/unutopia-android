package org.cacahuete.app.contentproviderpruebas.data;
...
public class MyContentProvider extends ContentProvider {
	...
	public String getType(Uri uri) {
		...
		case TYPE_USERS_COLLECTION:
			return "android.cursor.dir/vnd.org.cacahuete.app.contentproviderpruebas.users";
		case TYPE_USERS_ITEM:
			return "android.cursor.item/vnd.org.cacahuete.app.contentproviderpruebas.users";
		default:
			return null;
		}
	}
	...
	public int delete(Uri uri,String whereClause,String[] whereArgs) {
		...
		whereArgs=null;
		int num=db.delete(UsersTable.TABLE_NAME, whereClause, whereArgs);
		return num;		
	}
	...
	public int update(Uri uri, ContentValues values,String whereClause,String[] whereArgs) {
		...
		whereArgs=null;
		int num=db.update(UsersTable.TABLE_NAME, values, whereClause, whereArgs);
